...
#define SELECT_FORCE_CONTROLLER_ESTIMATOR FORCE_ADAPTIVE
#define FORCE_ADAPTIVE_WITHOUT_ICL 1
#define FORCE_ADAPTIVE_WITH_ICL 2
#define SELECT_FORCE_ADAPTIVE_W_WO_ICL  FORCE_ADAPTIVE_WITH_ICL

/* Moment Controller*/
#define MOMENT_EMK 1 
#define MOMENT_ADAPTIVE 2
#define MOMENT_CL 3
#define SELECT_MOMENT_CONTROLLER_ESTIMATOR MOMENT_ICL
